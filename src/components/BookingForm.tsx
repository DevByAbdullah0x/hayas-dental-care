  ...
  return (
    <section className="w-full py-space-xl px-margin-mobile md:px-margin max-w-4xl mx-auto" id="smart-booking">
      <div className="rounded-3xl bg-surface-container-lowest border border-[#1E6FFF]/20 p-space-lg md:p-space-xl shadow-xl flex flex-col gap-space-lg relative overflow-hidden">
        ...
        {/* Booking Form */}
        <form className="flex flex-col gap-space-md relative z-10" id="clinic-booking-form" onSubmit={handleBookingSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-space-md">
            {/* Full Name */}
            <div className="flex flex-col gap-1.5">
              <label className="font-label-ui text-label-ui font-semibold text-primary" htmlFor="book-name">
                Patient Full Name *
              </label>
              <input
            ...
            {/* Phone Number */}
            <div className="flex flex-col gap-1.5">
              <label className="font-label-ui text-label-ui font-semibold text-primary" htmlFor="book-phone">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-space-md">
            {/* Treatment Selection */}
            <div className="flex flex-col gap-1.5">
              <label className="font-label-ui text-label-ui font-semibold text-primary" htmlFor="book-service">
            ...
            {/* Preferred Shift */}
            <div className="flex flex-col gap-1.5">
              <label className="font-label-ui text-label-ui font-semibold text-primary" htmlFor="book-shift">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-space-md">
            <div className="flex flex-col gap-1.5">
              <label className="font-label-ui text-label-ui font-semibold text-primary" htmlFor="book-date">
