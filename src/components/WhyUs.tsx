    ...
    <section className="w-full py-space-xl px-margin-mobile md:px-margin bg-surface-container-low" id="why-us">
      <div className="max-w-7xl mx-auto flex flex-col gap-space-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-space-md">
          <div className="p-space-md rounded-2xl bg-surface-container-lowest border border-[#1E6FFF]/15 shadow-sm hover:border-[#1E6FFF]/40 transition-all flex flex-col gap-2">
            <span className="material-symbols-outlined text-[#1E6FFF] text-[32px]">balance</span>
          ...
          <div className="p-space-md rounded-2xl bg-surface-container-lowest border border-[#1E6FFF]/15 shadow-sm hover:border-[#1E6FFF]/40 transition-all flex flex-col gap-2">
            <span className="material-symbols-outlined text-[#1E6FFF] text-[32px]">volunteer_activism</span>
          ...
          <div className="p-space-md rounded-2xl bg-surface-container-lowest border border-[#1E6FFF]/15 shadow-sm hover:border-[#1E6FFF]/40 transition-all flex flex-col gap-2">
            <span className="material-symbols-outlined text-[#1E6FFF] text-[32px]">devices</span>
          ...
          <div className="p-space-md rounded-2xl bg-surface-container-lowest border border-[#1E6FFF]/15 shadow-sm hover:border-[#1E6FFF]/40 transition-all flex flex-col gap-2">
            <span className="material-symbols-outlined text-[#1E6FFF] text-[32px]">person_check</span>
        ...
        <div className="flex flex-col gap-space-md">
          <div className="flex flex-col gap-1">
            <span className="font-label-caps text-label-caps text-[#1E6FFF] font-bold tracking-wider uppercase">Setting the Gold Standard</span>
            <h3 className="font-headline-md text-headline-md text-primary font-semibold">How Haya&#39;s Dental Care Compares</h3>
          </div>
          <div className="overflow-x-auto">
            <div className="min-w-[640px] rounded-2xl overflow-hidden bg-surface-container-lowest border border-[#1E6FFF]/20 shadow-sm">
              <div className="grid grid-cols-12 bg-[#121417] p-4 font-label-caps text-[12px] font-bold text-white tracking-wider border-b border-[#1E6FFF]/30">
              ...
              <div className="grid grid-cols-12 p-4 items-center border-b border-surface-container text-body-md">
                ...
                <div className="col-span-4 text-[#1E6FFF] font-semibold">Vibration-assisted, warm-buffered numbing with zero sting</div>
                <div className="col-span-4 text-on-surface-variant">Cold, rushed injection causing needle pain</div>
              </div>
              <div className="grid grid-cols-12 p-4 items-center border-b border-surface-container text-body-md bg-surface-container-low/50">
                <div className="col-span-4 font-semibold text-primary">Sterilization Protocol</div>
                <div className="col-span-4 text-[#1E6FFF] font-semibold">Class-B vacuum autoclave; pouches opened chairside</div>
              ...
              <div className="grid grid-cols-12 p-4 items-center border-b border-surface-container text-body-md">
                ...
                <div className="col-span-4 text-[#1E6FFF] font-semibold">Itemized written plan before treatment commences</div>
              ...
              <div className="grid grid-cols-12 p-4 items-center border-b border-surface-container text-body-md bg-surface-container-low/50">
                ...
                <div className="col-span-4 text-[#1E6FFF] font-semibold">Always Dr. Aayisha Quddus (BDS, MIHS, RDS, C-Ortho)</div>
              ...
              <div className="grid grid-cols-12 p-4 items-center text-body-md">
                ...
                <div className="col-span-4 text-[#1E6FFF] font-semibold">Direct WhatsApp helpline with on-call doctor advice</div>
