export default function TopBar() {
  return (
    <aside className="w-full bg-[#121417] border-b border-[#1E6FFF]/20 text-[#A9B1BA] text-label-caps font-label-caps tracking-wider text-xs overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 xl:px-8 py-1.5 flex items-center justify-between gap-2">
