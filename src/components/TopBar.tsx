export default function TopBar() {
  return (
    <aside className="w-full bg-[#121417] border-b border-[#1E6FFF]/20 text-[#A9B1BA] text-label-caps font-label-caps tracking-wider px-3 sm:px-6 md:px-margin py-1.5 flex items-center justify-between gap-2 text-xs">
      <div className="flex items-center gap-2 truncate">
        ...
        <span className="text-[#8FCBF2] font-semibold text-[11px] sm:text-xs whitespace-nowrap">
      ...
      <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
        <a
          className="flex items-center gap-1 text-white hover:text-[#1E6FFF] transition-colors py-1 min-h-[32px] text-[11px] sm:text-xs"
        ...
        <a
          className="hidden sm:flex items-center gap-1 text-[#8FCBF2] hover:text-white transition-colors py-1 min-h-[32px] text-[11px] sm:text-xs"
