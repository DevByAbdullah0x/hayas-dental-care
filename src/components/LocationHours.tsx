  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-space-xl items-stretch">
        ...
        <div className="lg:col-span-6 p-space-lg rounded-3xl bg-surface-container-lowest border border-secondary/10 shadow-md flex flex-col justify-between gap-space-md">
          ...
          <div className="flex flex-col divide-y divide-surface-container-high font-body-md text-on-surface">
            ...
            <div className="py-3 flex items-center justify-between">
              ...
              <div className="text-right text-[13px] text-secondary font-medium">
                Dedicated Surgical Cases &amp; Emergencies
              </div>
            </div>
          </div>

          <div className="p-3 rounded-xl bg-surface-container flex items-center gap-2 text-label-ui text-primary">
        ...
        <div className="lg:col-span-6 p-space-lg rounded-3xl bg-surface-container-lowest border border-secondary/10 shadow-md flex flex-col justify-between gap-space-md">
          ...
          >
            <div className="px-3 py-1.5 rounded-xl bg-surface/90 backdrop-blur-md text-primary font-label-caps text-[11px] font-bold shadow-sm flex items-center gap-1.5">
          ...
          <div className="flex flex-wrap gap-2 pt-2 border-t border-surface-container-high">
            <a
              className="flex-1 min-w-[160px] py-3 rounded-xl bg-primary text-on-primary font-label-ui text-label-ui font-semibold flex items-center justify-center gap-1.5 hover:bg-primary-container transition-colors"
            ...
            <a
              className="flex-1 min-w-[160px] py-3 rounded-xl bg-secondary-container text-on-secondary-container font-label-ui text-label-ui font-semibold flex items-center justify-center gap-1.5 hover:bg-secondary-fixed transition-colors"
