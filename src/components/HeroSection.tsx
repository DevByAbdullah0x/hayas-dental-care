    ...
    <section className="relative w-full overflow-hidden bg-[#121417] text-white px-4 sm:px-6 md:px-margin pt-6 sm:pt-8 pb-12 sm:pb-16 md:pb-space-xl">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-space-xl items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start gap-4 sm:gap-6">
          {/* Trust Kicker Badge */}
          <div className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 rounded-full bg-[#1B1F24] shadow-[0_0_12px_rgba(30,111,255,0.2)] border border-[#1E6FFF]/30 backdrop-blur-md max-w-full">
            <div className="flex items-center text-amber-400 text-[13px] sm:text-[14px] flex-shrink-0">
              {[...Array(5)].map((_, i) => (
                <span
                  key={i}
                  className="material-symbols-outlined text-[15px] sm:text-[16px] text-amber-400 fill-current"
            ...
            <span className="font-label-caps text-[10px] sm:text-[11px] text-white font-semibold tracking-wider truncate">
              4.9/5.0 RATING · 180+ VERIFIED REVIEWS
            </span>
          </div>

          {/* Hero Headline with Neon Glow & Fluid Sizing */}
          <h1 className="font-display-hero text-3xl sm:text-4xl md:text-5xl lg:text-[52px] xl:text-[56px] text-white tracking-tight leading-[1.15]">
            Gentle, precise dental care for{" "}
            <span className="font-editorial-italic italic text-[#1E6FFF] text-neon-glow underline decoration-[#8FCBF2] decoration-wavy decoration-2">
              every smile
            </span>{" "}
            in your family.
          </h1>
          ...
          {/* Lede Body Text */}
          <p className="font-body-lg text-sm sm:text-base md:text-lg text-[#A9B1BA] max-w-2xl leading-relaxed">
            Led by{" "}
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto pt-1">
            <Link
              className="btn-neon inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full font-label-ui text-sm font-semibold text-white min-h-[48px] text-center"
              href="#smart-booking"
            >
            ...
            <a
              className="inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-full bg-[#1B1F24] text-white border border-[#1E6FFF]/30 hover:border-[#1E6FFF] hover:text-[#8FCBF2] transition-colors font-label-ui text-sm min-h-[48px] text-center"
            ...
            <a
              className="inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-full bg-[#1E6FFF]/15 text-[#8FCBF2] border border-[#1E6FFF]/40 hover:bg-[#1E6FFF] hover:text-white transition-all shadow-[0_0_15px_rgba(30,111,255,0.2)] font-label-ui text-sm min-h-[48px] text-center"
          ...
          {/* Social Proof Stack */}
          <div className="pt-3 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 border-t border-[#1B1F24] w-full">
            <div className="flex -space-x-2.5 items-center flex-shrink-0">
              <img
                className="w-9 h-9 rounded-full border-2 border-[#121417] object-cover shadow-sm"
              ...
              />
              <div className="w-9 h-9 rounded-full bg-[#1E6FFF] text-white flex items-center justify-center font-label-caps text-[10px] font-bold shadow-[0_0_10px_rgba(30,111,255,0.5)]">
                2.5K+
              </div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <span className="font-label-caps text-[10px] sm:text-[11px] text-[#A9B1BA]">
        ...
        <div className="lg:col-span-5 relative w-full">
          <div className="rounded-2xl p-4 sm:p-6 bg-[#1B1F24] backdrop-blur-xl shadow-[0_0_35px_rgba(30,111,255,0.15)] border border-[#1E6FFF]/30 flex flex-col gap-4 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 sm:gap-4 pb-3 sm:pb-4 border-b border-[#1E6FFF]/20">
              <div className="relative w-16 sm:w-20 h-16 sm:h-20 rounded-2xl overflow-hidden shadow-[0_0_15px_rgba(30,111,255,0.3)] flex-shrink-0 border-2 border-[#1E6FFF]/40">
                <img
                  alt="Dr. Aayisha Quddus BDS MIHS RDS C-Ortho"
                  className="w-full h-full object-cover"
                  src="/dr-aayisha-quddus.jpg"
                />
                <span className="absolute bottom-1 right-1 w-3 h-3 rounded-full bg-[#1E6FFF] border-2 border-[#1B1F24]"></span>
              </div>
              <div className="flex flex-col min-w-0">
                <div className="inline-flex items-center gap-1.5">
                  <span className="font-headline-sm text-base sm:text-lg text-white font-bold truncate text-neon-glow">
                    Dr. Aayisha Quddus
                  </span>
                  <span
                    className="material-symbols-outlined text-[#1E6FFF] text-[18px] flex-shrink-0"
                    title="Verified PMDC Surgeon"
                  >
                    verified
                  </span>
                </div>
                <span className="font-label-ui text-xs text-[#A9B1BA] truncate">
                  BDS, MIHS, RDS (Pak), C-Ortho
                </span>
                <span className="font-label-caps text-[10px] text-[#8FCBF2] font-semibold mt-0.5 tracking-wider">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <span className="font-label-caps text-[10px] sm:text-[11px] text-[#A9B1BA] tracking-wider">
              ...
              <div className="grid grid-cols-2 p-1 rounded-xl bg-[#121417] border border-[#1E6FFF]/20 text-xs">
                <button
                  type="button"
              ...
              <div className="p-3 sm:p-3.5 rounded-xl bg-[#121417] border border-[#1E6FFF]/25 flex flex-col gap-1.5">
                ...
                <div className="flex items-center justify-between font-label-caps text-[10px] sm:text-[11px] text-[#A9B1BA]">
            ...
            <Link
              className="btn-neon w-full py-3.5 rounded-xl font-label-ui text-sm font-semibold text-center flex items-center justify-center gap-2 text-white min-h-[48px]"
              href="#smart-booking"
            >
              <span className="material-symbols-outlined text-[18px]">
                calendar_today
