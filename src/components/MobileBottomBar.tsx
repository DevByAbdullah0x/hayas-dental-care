  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 gap-2 w-full max-w-lg mx-auto">
        {/* 1. Call Button (Secondary Style) */}
        <a
          className="flex items-center justify-center gap-1.5 h-11 px-2 rounded-xl bg-[#EEF6F5] border border-[#0F5C5E]/25 text-[#0F5C5E] text-xs font-semibold hover:bg-[#E2ECE9] active:bg-[#0F5C5E]/10 transition-all whitespace-nowrap"
        ...
        >
          <span className="w-5 h-5 flex items-center justify-center flex-shrink-0" aria-hidden="true">
            <span className="material-symbols-outlined text-[18px] leading-none w-[18px] h-[18px] flex items-center justify-center text-current select-none">
              call
            </span>
          </span>
        ...
        {/* 2. WhatsApp Button (Secondary Style) */}
        <a
          className="flex items-center justify-center gap-1.5 h-11 px-2 rounded-xl bg-[#EEF6F5] border border-[#0F5C5E]/25 text-[#0F5C5E] text-xs font-semibold hover:bg-[#E2ECE9] active:bg-[#0F5C5E]/10 transition-all whitespace-nowrap"
        ...
        {/* 3. Book Slot Button (Primary Style) */}
        <a
          className="flex items-center justify-center gap-1.5 h-11 px-2 rounded-xl bg-[#0F5C5E] hover:bg-[#083F42] active:bg-[#083F42] text-white border border-[#0F5C5E] text-xs font-semibold shadow-soft transition-all whitespace-nowrap"
          href="#smart-booking"
